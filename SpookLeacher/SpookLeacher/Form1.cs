                    ...
                    if (more)
                    {
                        using (var req = new HttpRequest())
                        {
                            ...
                            foreach (string s in splits)
                            {
                                ...
                                else if (url.Contains("pastebin.com/") && !url.Contains("gmail") && !url.Contains("=") && !url.Contains("search") && !url.Contains("chrome") && !url.Contains("roblox") && !url.Contains("google") && !url.Contains("how") && !url.Contains("free") && !url.Contains("accounts"))
                                {
                                    linkout(url);
                                }
